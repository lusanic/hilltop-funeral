...
public class NewGameManager : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector3 m_casketStartlocalEulerAngles;
    ...
    void Start()
    {
        ...
        m_casketStartlocalEulerAngles = casket.transform.localEulerAngles;
    ...
    public IEnumerator deathReset()
    {
        ...
        resetBodyRotation();
        casket.GetComponent<NewCasket>().SetlocalEulerAngles(m_casketStartlocalEulerAngles);
